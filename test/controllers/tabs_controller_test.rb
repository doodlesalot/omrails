...
class TabsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tab" do
    assert_difference('Tab.count') do
      post tabs_url, params: { tab: { content: @tab.content, title: @tab.title, user_id: @tab.user_id } }
    end
  ...
  test "should update tab" do
    patch tab_url(@tab), params: { tab: { content: @tab.content, title: @tab.title, user_id: @tab.user_id } }
